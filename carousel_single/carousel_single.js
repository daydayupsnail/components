...
*/
define('carousel_single',function(require, exports, module) {
  function CarouselSingle(o){
    o=o||{};
...
//        this.elems.eq(index).attr("data-left",left);
        ...
        p = this.elems.eq(index).animate({
          "left":left,
        },this.animationtime,"easeInOutSine").promise();
      }
      return p;
    },
    gonext:function(){
